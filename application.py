...
def index():
    ...
    """ Show search box with links to Login/Register """
...
def login():
    ...
    if request.method == "POST":
        ...
        # Is username there & password is correct
...
def register():
    ...
    if request.method == "POST":
        ...
        # Ensure username was submitted
        if not request.form.get("username"):
            return render_template("error.html", message="You need to submit a username")
        ...
        # Ensure password was submitted
            ...
            return render_template("error.html", message="You need to submit a password")
        ...
        # Check passwords are equal
            ...
            return render_template("error.html", message="mismatched passwords")
...
def book(isbn):
    ...
    if request.method == "POST":
        ...
        flash('Thanks for your comment!', 'info')
